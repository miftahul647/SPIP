...
class DataApiJagaSekolahFasilitasNpsnController extends Controller
{
    public function index()
    {
        try {   
            ...
            return response()->json(['data' => $paginate_component->paginate($getApiInitialization->getApi('https://bima.kpk.go.id/api/v5/sekolah/fasilitas?npsn=20208347')['data']['result'])],200);   
